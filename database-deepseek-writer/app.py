...
def save_skills_response():
    ...
    try:
        ...
        with conn.cursor() as cursor:
            sql = """
                INSERT INTO deepseek_response_skills (
                    student_id,
                    java_response,
                    sql_response,
...
def save_hobbies_response():
    ...
    try:
        ...
        with conn.cursor() as cursor:
            sql = """
                INSERT INTO deepseek_response_hobbies (
                    student_id,
                    java_response,
                    sql_response,
                    data_mining_response,
...
def save_subjects_response():
    ...
    try:
        ...
        with conn.cursor() as cursor:
            sql = """
                INSERT INTO deepseek_response_subjects (
                    student_id,
                    java_response,
                    sql_response,
                    data_mining_response,
...
def save_all_response():
    ...
    try:
        ...
        with conn.cursor() as cursor:
            sql = """
                INSERT INTO deepseek_response_all (
                    student_id,
                    java_response,
                    sql_response,
                    data_mining_response,
...
def save_default_response():
    ...
    try:
        ...
        with conn.cursor() as cursor:
            sql = """
                INSERT INTO deepseek_response_default (
                    question_id,
                    response
                ) VALUES (%s, %s)
            """
